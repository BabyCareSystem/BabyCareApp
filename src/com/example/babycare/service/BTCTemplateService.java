...
import com.example.babycare.bluetooth.*;
import com.example.babycare.contents.CommandParser;
import com.example.babycare.fragments.Crying_Show_Activity;
import com.example.babycare.fragments.Humidity_Show_Activity;
import com.example.babycare.fragments.Temper_Show_Activity;
import com.example.babycare.fragments.TurnOver_Show_Activity;
import com.example.babycare.utils.AppSettings;
import com.example.babycare.utils.Constants;
import com.example.babycare.utils.Logs;
		...
		public void handleMessage(Message msg) {
			...
			case BluetoothManager.MESSAGE_READ:
				...
				if(msg.arg1 > 0) {
		    		...
		    		if(strMsg.toString().equals("a")||strMsg.toString().equals("b")||strMsg.toString().equals("c")
							||strMsg.toString().equals("d")||strMsg.toString().equals("e")||strMsg.toString().equals("f")){
		        		temp = 34;
					}
					else if(strMsg.toString().equals("g")||strMsg.toString().equals("h")||strMsg.toString().equals("i")){
						temp = 60;
					}
					else if(strMsg.toString().equals("j")){
						temp = 70;
					}
					else if(strMsg.toString().equals("k")){
						temp = 90;
					}
		    		
		    		
		    		if(temp==34){
		    			Intent i = new Intent(mContext,Temper_Show_Activity.class);
		    			i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						mContext.startActivity(i);	
		    		}
		    		else if(temp==60){
		    			Intent i = new Intent(mContext, Crying_Show_Activity.class);
		    			i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						mContext.startActivity(i);
		    		}
		    		else if(temp==70){
		    			Intent i = new Intent(mContext, TurnOver_Show_Activity.class);
		    			i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						mContext.startActivity(i);
		    		}
		    		else if(temp==90){
		    			Intent i = new Intent(mContext, Humidity_Show_Activity.class);
		    			i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						mContext.startActivity(i);
		    		}
